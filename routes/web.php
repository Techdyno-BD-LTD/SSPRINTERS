...
Route::prefix('admin')->middleware(['auth', 'xss', 'role:admin'])->group(function () {
    ...
    Route::get('delivery_challan/create', [DeliveryChallanController::class, 'create'])->name('delivery_challan.create');
    Route::post('delivery_challan/create', [DeliveryChallanController::class, 'store'])->name('delivery_challan.store');
    Route::get('delivery_challan/searchInvoice', [DeliveryChallanController::class, 'searchInvoice'])->name('delivery_challan.searchInvoice');
    Route::get('delivery_challan/print/{id}', [DeliveryChallanController::class, 'print'])->name('delivery-challan.print');
    Route::get('performa-invoice/print/{id}', [PerformaInvoiceController::class, 'print'])->name('performa-invoice.print');
    Route::resource('delivery-challan', DeliveryChallanController::class);
    Route::resource('performa-invoice', PerformaInvoiceController::class);
    ...
    Route::get('/categories/{category}/variations', [CategoryController::class, 'variations'])->name('category.variations');

    //Product Route
    Route::resource('products', ProductController::class);
    Route::get('/get-product-variations', [ProductController::class, 'getProductVariations'])->name('get.product.variations');
