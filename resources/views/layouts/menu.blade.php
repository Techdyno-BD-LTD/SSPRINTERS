@role('admin')
    ...
    <li class="nav-item {{ Request::is('admin/client*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('clients.index') }}">
            ...
            <span class="aside-menu-title">{{ __('Client Add/Update') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item d-none {{ Request::is('admin/taxes*') ? 'active' : '' }}">
    ...
    <li class="nav-item {{ Request::is('admin/products*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('products.index') }}">
            ...
            <span class="aside-menu-title">{{ __('Product Entry') }}</span>
        </a>
    </li>

    <li class="nav-item {{ Request::is('admin/delivery-challan*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="/admin/delivery-challan">
            <span class="menu-icon">
                <i class="fa-solid fas fa-quote-left pe-3"></i>
            </span>
            <span class="aside-menu-title">{{ __('Delivery Chalan') }}</span>
        </a>
    </li>

    <li class="nav-item {{ Request::is('admin/performa-invoice*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="/admin/performa-invoice">
            <span class="menu-icon">
                <i class="fa-solid fas fa-quote-left pe-3"></i>
            </span>
            <span class="aside-menu-title">{{ __('Performa Invoice') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item d-none {{ Request::is('admin/payment-qr-codes*') ? 'active' : '' }}">
    ...
    <li class="nav-item d-none {{ Request::is('admin/transactions*') ? 'active' : '' }}">
    ...
    <li class="nav-item d-none {{ Request::is('admin/payments*') ? 'active' : '' }}">
    ...
    <li class="nav-item d-none {{ Request::is('admin/template-setting*') ? 'active' : '' }}">
