<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-4">
        <div class="mb-5">
            ...
            {{ Form::select('category_id', $categories, null, ['id' => 'categoryId', 'class' => 'form-select io-select2', 'placeholder' => __('messages.product.category'), 'required', 'data-control' => 'select2', 'onchange' => 'handleCategoryChange(event)']) }}
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="mb-5">
            ...
            {{ Form::number('unit_price', null, ['id' => 'unitPriceId', 'class' => 'form-control', 'placeholder' => __('messages.product.unit_price'), 'min' => '0', 'step' => '.01', 'oninput' => "validity.valid||(value=value.replace(/\D+/g, '.'))"]) }}
        </div>
    </div>
    <div class="col-lg-4">
        <div class="mb-5">
                        ...
                        const variationsSelect = `
                            <div class="mb-5">
                                ...
                                <select name="variations[]" id="variations" class="form-select" multiple>
                                    ${data.map(variation => `<option value="${variation.value}">${variation.value}</option>`).join('')}
                                </select>
                            </div>
                        `;
