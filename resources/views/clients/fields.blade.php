<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6 d-none">
        <div class="mb-5">
            ...
            {{ Form::email('email', "test@gmail.com", ['class' => 'form-control', 'placeholder' => __('messages.client.email')]) }}
        </div>
    </div>
    <div class="col-lg-6 d-none">
        <div class="mb-5">
            ...
            <div class="">
                ...
                <div class="position-relative">
                    <input class="form-control" type="password" placeholder="{{ __('messages.client.password') }}"
                        name="password" autocomplete="off" value="123456789" aria-label="password" data-toggle="password" required>
                    <span
            ...
            <div class="">
                ...
                <div class="position-relative">
                    <input class="form-control" type="password"
                        ...
                        autocomplete="off" value="123456789" aria-label="Password" data-toggle="password" required>
                    <span
                        class="position-absolute d-flex align-items-center top-0 bottom-0 end-0 me-4 input-icon input-password-hide cursor-pointer text-gray-600">
                        <i class="bi bi-eye-slash-fill"></i>
                    </span>
    ...
    <div class="col-lg-6 d-none">
        <div class="mb-5">
            ...
            {{ Form::text('website', 'https://www.techdynobd.com', ['class' => 'form-control', 'placeholder' => __('messages.client.website')]) }}
        </div>
    </div>
    <div class="col-lg-6 d-none">
        <div class="mb-5">
            {{ Form::label('postal_code', __('messages.client.postal_code') . ':', ['class' => 'form-label  mb-3 required']) }}
            {{ Form::text('postal_code', '1234', ['class' => 'form-control', 'placeholder' => __('messages.client.postal_code'), 'required']) }}
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('address', __('Address/Bottom Text') . ':', ['class' => 'form-label mb-3']) }}
    ...
    <div class="col-xl-3 col-lg-2 mb-7 d-none">
    ...
    <div class="col-xl-3 col-lg-4 mb-7 d-none">
