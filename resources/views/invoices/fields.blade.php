<div class="row">
    ...
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('po_number', __('Po Number') . ':', ['class' => 'form-label required mb-3']) }}
        {{ Form::text('po_number', null, ['class' => 'form-control', 'id' => 'po_number', 'autocomplete' => 'off', 'required']) }}
    </div>
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('style_number', __('Style Number') . ':', ['class' => 'form-label required mb-3']) }}
        {{ Form::text('style_number', null, ['class' => 'form-control', 'id' => 'style_number', 'autocomplete' => 'off', 'required']) }}
    </div>
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('po_value', __('PO Value') . ':', ['class' => 'form-label required mb-3']) }}
        {{ Form::text('po_value', null, ['class' => 'form-control', 'id' => 'po_value', 'autocomplete' => 'off', 'required']) }}
    </div>
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('costing', __('Costing') . ':', ['class' => 'form-label required mb-3']) }}
        {{ Form::text('costing', null, ['class' => 'form-control', 'id' => 'costing', 'autocomplete' => 'off', 'required']) }}
    </div>
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('profit_loss', __('Profit/Loss') . ':', ['class' => 'form-label required mb-3']) }}
        {{ Form::text('profit_loss', null, ['class' => 'form-control', 'id' => 'profit_loss', 'autocomplete' => 'off', 'required']) }}
    </div>
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('verdict', __('Verdict') . ':', ['class' => 'form-label required mb-3']) }}
        {{ Form::text('verdict', null, ['class' => 'form-control', 'id' => 'verdict', 'autocomplete' => 'off', 'required']) }}
    </div>
    ...
    <div class="mb-5 col-lg-4 col-sm-12 d-none">
        {{ Form::label('due_date', __('messages.invoice.due_date') . ':', ['class' => 'form-label required mb-3']) }}
        {{ Form::text('due_date', null, ['class' => 'form-select', 'id' => 'due_date', 'autocomplete' => 'off']) }}
    </div>
    ...
    <div class="mb-5 col-lg-4 col-sm-12 mt-8 d-none">
            ...
            <table class="table table-striped box-shadow-none mt-4" id="billTbl">
                <thead>
                    <tr class="border-bottom fs-7 fw-bolder text-gray-700 text-uppercase">
                        ...
                        <th scope="col" class="required">{{ __('VARIATIONS') }}</th>
                ...
                <tbody class="invoice-item-container">
                    <tr class="tax-tr">
                        ...
                        <td class="table__item-desc w-25">
                            {{ Form::select('product_id[]', $products, null, ['class' => 'form-select product product_all io-select2', 'required', 'placeholder' => __('messages.flash.select_product_or_enter_free_text'), 'data-control' => 'select2']) }}
                        </td>
                        <td class="table__item-desc w-25">
                            {{ Form::select('variations[]', [], null, ['class' => 'form-select product variations io-select2', 'required', 'placeholder' => __('Variations'), 'data-control' => 'select2']) }}
                        </td>
                        <td class="table__qty">
