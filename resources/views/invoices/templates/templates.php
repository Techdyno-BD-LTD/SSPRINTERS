...
<tr class="border-bottom border-bottom-dashed tax-tr">
    ...
    <td class="table__item-desc w-25">
        <select class="form-select productId product product_all  fw-bold" name="product_id[]" 'data-control' => 'select2' required>
    ...
    <td class="table__item-desc w-25">
       <select class="form-select productId product variations  fw-bold"  name="variations[]" 'data-control' => 'select2' required>
        </select>
    </td>
    <td class="table__qty">
